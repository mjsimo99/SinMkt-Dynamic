...
<html class="no-js" lang="en">
    ...
    <head>
		...
		<link rel="stylesheet" href="../../Satoru-MVC1/views/assets/css/myresponsive.css">
				        ...
				        <div class="container">            
				                    ...
				                    <li class="dropdown">
				                        ...
				                        <ul class="dropdown-menu cart-list s-cate">
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="../../Satoru-MVC1/views/assets/images/collection/arrivals1.png" class="cart-thumb" alt="image" /></a>
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="../../Satoru-MVC1/views/assets/images/collection/arrivals2.png" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				                            ...
				                            <li class="single-cart-list">
				                                <a href="#" class="photo"><img src="../../Satoru-MVC1/views/assets/images/collection/arrivals3.png" class="cart-thumb" alt="image" /></a>
				                                <div class="cart-list-txt">
				            ...
				            <div class="navbar-header">
				                ...
				                <a class="navbar-brand" href="index">
									<img src="../../Satoru-MVC1/views/Sinemkt.png" alt="sinmkt"  >
								</a>
				            </div><!--/.navbar-header-->
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
				                    ...
				                    <li ><a href="newarrivel">new arrival</a></li>
									...
									<?php if(!isset($_SESSION['logged']) || $_SESSION['logged'] !== true){ ?>
									<li>
									<a href="<?php echo BASE_URL;?>login" title="Connexion" class="btn btn-link mr-2 mb-2">
									<i class="fa fa-user" aria-hidden="true" style="margin-right:10%;"></i>
									</a></li>
									<?php  } ?>
				                </ul><!--/.nav -->
				            </div><!-- /.navbar-collapse -->
